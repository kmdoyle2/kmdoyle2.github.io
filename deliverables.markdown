...
[![Project Pitch Preview](/assets/images/project-pitch-preview.png){: width="75%"}](/assets/documents/ProjectPitch.pdf){: target="_blank"}
{: .text-center}

[View Project Pitch PDF](/assets/documents/ProjectPitch.pdf){: .btn .btn--primary .btn--large target="_blank"}
{: .text-center}
...
[![Sprint 1 Presentation Preview](/assets/images/Sprint1Presentation.jpg){: width="75%"}](/assets/documents/Sprint1Presentation.pptx){: target="_blank"}
{: .text-center}

[View Sprint 1 Presentation](/assets/documents/Sprint1Presentation.pptx){: .btn .btn--primary .btn--large target="_blank"}
{: .text-center}

[![Sprint 1 Planning Document Preview](/assets/images/Sprint1Planning.jpg){: width="75%"}](/assets/documents/Sprint1PlanningDocument.pdf){: target="_blank"}
{: .text-center}
...
[![Sprint 1 Retrospective Preview](/assets/images/Sprint1Retrospective.png){: width="75%"}](/assets/documents/Sprint1Retrospective.pdf){: target="_blank"}
{: .text-center}

[View Sprint 1 Retrospective](/assets/documents/Sprint1Retrospective.pdf){: .btn .btn--primary .btn--large target="_blank"}
{: .text-center}

[View Sprint 1 Scrum Discussions](/assets/documents/ScrumDiscussionPosts.pdf){: .btn .btn--primary .btn--large target="_blank"}
{: .text-center}
